...
import com.jobsresearch.controller.jobsresearchv2.Manifest;
import com.jobsresearch.controller.jobsresearchv2.R;
import com.jobsresearch.controller.jobsresearchv2.api.MessageHelper;
...
public class ChatActivity extends BaseActivity implements ChatAdapter.Listener {
   ...
   // private static final String PERMS =Manifest.permission.;
    ...
    private void uploadPhotoInFirebaseAndSendMessage(final String message) {
        final String uuid = UUID.randomUUID().toString(); // GENERATE UNIQUE STRING
        // A - UPLOAD TO GCS
    ...
    private void chooseImageFromPhone(){
        if (!EasyPermissions.hasPermissions(this)) {
            EasyPermissions.requestPermissions(this, getString(R.string.popup_title_permission_files_access), RC_IMAGE_PERMS);
            return;
        }
