...
public class MessageViewHolder extends RecyclerView.ViewHolder {
    ...
    public void updateWithMessage(Message message, String currentUserId, RequestManager glide){
        ...
        String name =message.getUserSender().getUsername();
        // Update date TextView
        if (message.getDateCreated() != null) this.textViewDate.setText(name +'à'+ this.convertDateToHour(message.getDateCreated())  );


        // Update isMentor ImageView
        //this.imageViewIsMentor.setVisibility(message.getUserSender().equals(offre.getUid()) ? View.VISIBLE : View.INVISIBLE);
